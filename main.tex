...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{HARPS.2010-09-14T01_44_18.810cosmicRAY.png}
...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{HARPS_2013-08-18T05_02_20_353bleed.png}
...
A total of three candidates currently show no indication of being from a terrestrial source and do not match our criteria for any of our false positive categories, therefore warranting further investigation. These include a candidate from M-type stars HIP87607 (see: \ref{fig:seti_candidate_HIP87607}) and GJ317 (see: \ref{fig:seti_candidate_GJ317}, as well as from the oscillating red giant CD-312415.
...
\begin{table}
    ...
    \hline
    \end{tabular}
    \caption{Each candidate was subjected to a test where we checked other observations within a two hour window to see if there were recurrences of the same emission line on separate parts of the sky, and if so test whether or not these emissions are stationary in the terrrestrial frame. The verdicts from that test for each candidate are listed.}
